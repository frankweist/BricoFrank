# apply_plantillas_presets.ps1 — Plantillas de notas/diagnóstico + presets tarifa/horas
...
export function DetalleOrden({ ordenId }: { ordenId: string }) {
  ...
  function addTemplate(t:string){ setNota(n => (n ? (n.trim() + ' ' + t) : t)) }
    ...
    <section className="grid gap-4">
      <div className="card"><div className="card-body grid gap-4">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="text-sm opacity-70">Estado: {orden?.estado}</span>
        ...
        <div className="card"><div className="card-body grid gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button className="btn" onClick={()=>localStorage.setItem('gr_tarifa', String(tarifa))}>Guardar como predeterminada</button>
        ...
        <div className="grid lg:grid-cols-2 gap-3">
          <div className="card"><div className="card-body grid gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <select className="input" onChange={e=>{ if(e.target.value){ addTemplate(e.target.value); e.target.selectedIndex=0 } }}>
