...
// ¡IMPORTANTE! Hemos añadido laborCharge: number
export interface Orden { id:string; codigo:string; equipoId:string; estado:EstadoOrden; creada:string; actualizada:string; laborCharge: number }
