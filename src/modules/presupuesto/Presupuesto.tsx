...
export function Presupuesto(){
  const [horas,setHoras]=useState(1), [tarifa,setTarifa]=useState(25), [piezas,setPiezas]=useState(0)
  const manoObra=horas*tarifa, subtotal=manoObra+piezas, total=subtotal
